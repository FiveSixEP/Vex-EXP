Welcome to the GitHub repository for the VEX EXP robots! This repository contains all the code you need to program and control your VEX EXP robot using the VEXcode software.
